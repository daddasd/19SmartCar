...
uint16 ADC_MIN[7] = {400,400,400,400,400,400,400};
uint16 ADC_MAX[7] = {3200,3200,3200,4200,3200,3200,3200}; // 测出的电感最大，与最小值从左到右
...
void show_val(void)
{
	...
	oled_p6x8str(0, 3, "M1:");
	oled_uint16(15, 3, M1_NOR_ADC);

	oled_p6x8str(55, 3, "Err:");
	oled_int16(80, 3,Inductance_Error);
